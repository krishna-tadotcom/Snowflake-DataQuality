...
const EditValidation = () => {
  ...
  >
   ...
   <label style={{display:"inline-block"}}><span style={{fontWeight:"600",fontSize:"16px",color:"blue"}}>Dataset:</span> <span style={{textTransform:"capitalize",marginLeft:"5px"}}>{data.dataset}</span></label> 
   <label style={{display:"inline-block"}}><span style={{fontWeight:"600",fontSize:"16px",color:"blue"}}>Column:</span><span style={{textTransform:"capitalize",marginLeft:"5px"}}>{data.col}</span></label> 
   </div>
   <br />
   <div style={{display:"flex",justifyContent:"space-between",width:"450px"}}>
   <label style={{display:"inline-block"}}><span style={{fontWeight:"600",fontSize:"16px",color:"blue"}}>Expectation:</span>  <span style={{textTransform:"capitalize",marginLeft:"5px"}}>{data.exp}</span></label> 
   <label style={{display:"inline-block"}}><span style={{fontWeight:"600",fontSize:"16px",color:"blue"}}>Format:</span> <span style={{textTransform:"capitalize",marginLeft:"5px"}}>{data.exp}</span></label> 
   </div>
   <hr />
